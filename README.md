...
A hands-on tutorial in lab format that teaches **VPC Lattice service-to-service authentication** using IAM authorization on AWS. You'll deploy a minimal environment from scratch and observe both successful and blocked inter-service communication - proving that authorization is enforced at the infrastructure level, not in application code.
...
3. Follow the [Lab Walkthrough Guide](docs/WALKTHROUGH.md)

## Documentation

| Document | Description |
|----------|-------------|
| [Prerequisites](docs/PREREQUISITES.md) | Tools, permissions, and account requirements to get started |
| [Important Notes](docs/NOTICE.md) | Usage guidance, scope, and responsibility |
| [Lab Walkthrough Guide](docs/WALKTHROUGH.md) | Step-by-step guide through the tutorial |
