...
- [x] 1. Phase 1 — Base Infrastructure Terraform
  - [x] 1.1 Create Phase 1 provider and VPC resources (`lab/phase1/main.tf`)
  ...
  - [x] 1.2 Create IAM roles and policies (`lab/phase1/iam.tf`)
  ...
  - [x] 1.3 Create ECR repositories (`lab/phase1/ecr.tf`)
  ...
  - [x] 1.4 Create security groups (`lab/phase1/security.tf`)
  ...
  - [x] 1.5 Create Phase 1 outputs and variables (`lab/phase1/outputs.tf`, `lab/phase1/variables.tf`)
...
- [x] 3. Phase 2 — Container Application Code
  - [x] 3.1 Create Service_B Flask application (`lab/services/service_b/`)
  ...
  - [x] 3.2 Create shared caller script (`lab/services/caller/`)
...
- [x] 4. Checkpoint — Container code validation
  - Ensure caller.py and app.py are each under 50 lines
  - Ensure Dockerfiles are correct and minimal
  - Ask the user if questions arise.

- [x] 5. Phase 3 — ECS Services and VPC Lattice Terraform
  - [x] 5.1 Create Phase 3 provider and data sources (`lab/phase3/main.tf`, `lab/phase3/variables.tf`)
    - Configure AWS provider
    - Define variables for image URIs and Phase 1 outputs (subnet ID, SG IDs, role ARNs, VPC ID)
    - _Requirements: 12.2_

  - [x] 5.2 Create ECS cluster, task definitions, and Service_B ECS service (`lab/phase3/ecs.tf`)
  ...
  - [x] 5.3 Create VPC Lattice resources (`lab/phase3/lattice.tf`)
...
- [x] 7. Tutorial README
  - [x] 7.1 Create tutorial document (`lab/README.md`) — Sections: Overview through Architecture
  ...
  - [x] 7.2 Extend tutorial — Step-by-Step Deployment section
  ...
  - [x] 7.3 Extend tutorial — Testing and Validation section
  ...
  - [x] 7.4 Extend tutorial — Explanation, Cost, and Cleanup sections
